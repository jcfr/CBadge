...
router.get('/:project/pullRequest/:owner/:repo/:number/:sha', function(req, res) {
	...
	request(options, function (error, response, body) {
		if(error){
			...
			var comment = '| Base ('+baseSHA.substring(0, 7)+') | Merged ('+testingSHA.substring(0, 7)+')|\n|:---:|:---:|\n|[![Base Coverage Status]('+cbadgeURL+'/'+req.params.project+'/'+baseSHA+'/coverage.svg)](http://open.cdash.org/index.php?project='+req.params.project+')|[![Merge Coverage Status]('+cbadgeURL+'/'+testingSHA+'/coverage.svg)](http://open.cdash.org/index.php?project='+req.params.project+')\n|[![Base Testing Status]('+cbadgeURL+'/'+baseSHA+'/test.svg)](http://open.cdash.org/index.php?project='+req.params.project+')|[![Merge Testing Status]('+cbadgeURL+'/'+testingSHA+'/test.svg)](http://open.cdash.org/index.php?project='+req.params.project+')\n|[![Base Build Status]('+cbadgeURL+'/'+baseSHA+'/build.svg)](http://open.cdash.org/index.php?project='+req.params.project+')|[![Merge Build Status]('+cbadgeURL+'/'+testingSHA+'/build.svg)](http://open.cdash.org/index.php?project='+req.params.project+')\n|[![Base Configure Status]('+cbadgeURL+'/'+baseSHA+'/configure.svg)](http://open.cdash.org/index.php?project='+req.params.project+')|[![Merge Configure Status]('+cbadgeURL+'/'+testingSHA+'/configure.svg)](http://open.cdash.org/index.php?project='+req.params.project+')';
